...
<div class="container">
	...
	<c:if test='${QAInfo.notice_category == "PQA"}'>
		<div class="row">
	...
	<c:if test='${QAInfo.notice_category == "UQA"}'>
		<div class="row">
			<div class="col-lg-2 text-center MyPage_02_01_menu-left">문의 유형</div>
			<div class="col-lg-9 MyPage_02_01_menu-right">
				<input class="AdminReturn_02-text-box text-center" type="text"
					disabled placeholder="${QAInfo.notice_type}">
			</div>
		</div>
	</c:if>

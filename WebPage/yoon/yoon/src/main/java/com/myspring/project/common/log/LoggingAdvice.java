package com.myspring.project.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.myspring.project.*.service.*.*(..)) or "
			+ "execution(* com.myspring.project.*.dao.*.*(..))")
	...
	@After("execution(* com.myspring.project.*.service.*.*(..)) or "
			+ "execution(* com.myspring.project.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.myspring.project.*.service.*.*(..)) or "
			+ "execution(* com.myspring.project.*.dao.*.*(..))")

package com.myspring.baroip.user.vo;
...
public class UserVO {
	...
	private String user_birth_yaer;
	...
	public String getUser_birth_yaer() {
		return user_birth_yaer;
	}

	public void setUser_birth_yaer(String user_birth_yaer) {
		this.user_birth_yaer = user_birth_yaer;
	}

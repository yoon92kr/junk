...
<div class="container-fluid">
	...
	<div class="row">
		<div class="offset-lg-2 col-lg-8">
			...
			<div class="offset-lg-2 col-lg-2 text-center cs_02_header">
				<span>작성 일자</span>
			</div>
			...
			<div class="col-lg-2 text-center cs_02_listsection ">
					...
					<a class="myPage_test" href="#"><img
						src="${contextPath}/resources/img/common/Inquiries_correct.png" alt="문의내역 목록 수정하기버튼 이미지"></a>

					<a class="myPage_test" href="#"><img
						src="${contextPath}/resources/img/common/Inquiries_delete_01.png" alt="문의내역 목록 삭제버튼 이미지"
						></a>
			...
			<div class="col-lg-2 text-center cs_02_listsection ">
					...
					<a class="myPage_test" href="#"><img
						src="${contextPath}/resources/img/common/Inquiries_correct.png" alt="문의내역 목록 수정하기버튼 이미지"
></a>

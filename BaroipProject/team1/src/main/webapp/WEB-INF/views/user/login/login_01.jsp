   ...
   <div class="row">
        ...
        <div class="col-lg-4">
           ...
           <form action="${contextPath}/user/login.do" method="post">
              <input class="login_01-id-box" name="user_id" type="text" placeholder="아이디(이메일)를 입력해주세요.">
              <input class="login_01-pwd-box" name="user_pw" type="password" placeholder="비밀번호를 입력해주세요."><br>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
           ...
           <p class="login_01-join-text">
              바로입이 처음이신가요? <a href="${contextPath}/user/join_01.do">회원가입하기</a>
           </p>
        </div>
        <div class="col-lg-4"></div>
    </div>

...
<div class="container-fluid">
	<div class="row">
		<div class="col-lg-10 offset-lg-1 text-center product_01_banner">
			<img id="product_01_main_img"
				src="${contextPath}/resources/img/common/meat_main_banner.jpg"
				alt="상품리스트 배너 이미지">
		</div>
	</div>
	...
	<div class="row">
		...
		<a href="${contextPath}/product/product_list/meat.do?sub_option=전체">
		축산물 전체
		</a>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-lg-6 offset-lg-3 text-center product_01_sub_title">	
			<a href="${contextPath}/product/product_list/meat.do?sub_option=돼지고기">돼지고기</a> 
			<a href="${contextPath}/product/product_list/meat.do?sub_option=소고기">소고기</a> 
			<a href="${contextPath}/product/product_list/meat.do?sub_option=기타">기타</a>
		</div>
	</div>
...
<div class="container">
	...
	<div class="row product_01_filter">
		<div class="col-lg-7 text-left">
			<a id="count" href="${contextPath}/product/product_list/meat.do?order_option=count">판매 인기순</a> 
			<a id="cre_date" href="${contextPath}/product/product_list/meat.do?order_option=cre_date">등록일순</a> 
			<a id="high_price" href="${contextPath}/product/product_list/meat.do?order_option=high_price">높은 가격순</a> 
			<a id="low_price" href="${contextPath}/product/product_list/meat.do?order_option=low_price">낮은 가격순</a>
		</div>
		...
		<div class="col-lg-4">
			...
			<div class="row item-format">
				...
				<div class="col-lg-3 text-right">
					<button class="main_cartImage" id="product_03_${i}" type="button" value="${itemList[key].product_id}" onclick="cartBTN(this);">
...
// 페이지 이동 스크립트
	function pageMove(no) {
		...
		if(no == "이전") {
			...
			document.location='${contextPath}/product/product_list/meat.do?pageNo='+(--getValue);
			}
		}
		else if (no == "다음") {
			...
			document.location='${contextPath}/product/product_list/meat.do?pageNo='+no;
		}
	}

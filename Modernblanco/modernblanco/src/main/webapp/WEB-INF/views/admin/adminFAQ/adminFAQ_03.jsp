...
<form action="${contextPath}/admin/FAQ/add_FAQ.do" method="post"
		id="admin_add_notice">
	<div class="row">
	...
	<input type="hidden" name="notice_category" value="FAQ" >
</form>
...
<div class="container-fluid">
	...
	<div class="row align-items-center">
		<div class="offset-lg-4 col-lg-2  justify-center join_02-bottom-btn">
			<div class="bottom_btn_size admin_product_list_btn">
			
				<a href="#" onclick="submit_add_notice()">
					<input type="button" class="admin_btn_blue" value="FAQ 등록">
				</a>

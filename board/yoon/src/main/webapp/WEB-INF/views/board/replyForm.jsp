 ...
 <h1>답글쓰기</h1>
  <form name="frmReply" method="post"  action="${contextPath}/board/addReply.do"   enctype="multipart/form-data">
    ...
    <tr>
			...
			<td><input type="text" size="20" maxlength="100"  name="writer" value="${member.name }" readonly></input> </td>
			<td><input type="hidden" name="matchNO" value="${matchNO }"></td>
		</tr>
		<tr>
		...
		<tr>
            ...
            <td><img  id="preview" src="${contextPath}/resources/image/preview.png"   width=200 height=200/></td>
		</tr>
		<tr>
			<td align="right"> </td>
			<td>
